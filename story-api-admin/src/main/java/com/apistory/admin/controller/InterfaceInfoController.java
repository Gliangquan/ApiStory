...
import com.apistory.admin.common.*;
...
import com.apistory.admin.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.apistory.admin.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.apistory.admin.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.apistory.admin.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
...
import com.apistory.common.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    @Resource
    private ApiStorySdk apiStorySdk;
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        String name = "liangquan";
        String num = RandomUtil.randomNumbers(4);
        String username = apiStorySdk.getUsernameByPost(name, num);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        if (StringUtils.isBlank(requestParams)){
            userRequestParams = "body";
        }else {
            userRequestParams = interfaceInfoInvokeRequest.getUserRequestParams();
        }

        // 随机数（防止请求重放，应该在前端传入）
        String num = request.getHeader("X-Custom-Nonce");

        // 获取用户数据
        User loginUser = userService.getLoginUser(request);
        String accessKey = loginUser.getAccessKey();
        String secretKey = loginUser.getSecretKey();
        ApiStorySdk apiClientSdk = new ApiStorySdk(accessKey, secretKey);

        String invokeResult = null;
        try {
            invokeResult = apiClientSdk.invokeInterface(num, userRequestParams, url, method);
